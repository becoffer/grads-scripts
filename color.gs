...
*** special kind
  ...
  if( kind = 'nowrad'  ); kind='white->(0,236,236)->(1,160,246)->(0,0,246)->(0,255,0)->(0,200,0)->(0,144,0)->(255,255,0)->(231,192,0)->(255,144,0)->(255,0,0)->(214,0,0)->(255,0,255)->(153,85,201)->white'; endif
  if( kind = 'BuRd' ); kind='(5,48,97)->(33,102,172)->(67,147,195)->(146,197,222)->white->(244,165,130)->(214,96,77)->(178,24,43)->(103,0,31)'; endif
  if( kind = 'RdBu' ); kind='(103,0,31)->(178,24,43)->(214,96,77)->(244,165,130)->white->(146,197,222)->(67,147,195)->(33,102,172)->(5,48,97)'; endif
  if( kind = 'BrBG' ); kind='(84,48,5)->(140,81,10)->(191,129,45)->(223,194,125)->white->(128,205,193)->(53,151,143)->(1,102,94)->(0,60,48)'; endif
  if( kind = 'OjPu' ); kind='(130,60,7)->(235,152,52)->white->(142,131,183)->(45,0,75)'; endif
  if( kind = 'PuOj' ); kind='(45,0,75)->(142,131,183)->white->(235,152,52)->(130,60,7)'; endif
  if( kind = 'YeBu' ); kind='(249,208,2)->(252,232,131)->white->(145,163,253)->(10,50,250)'; endif
  if( kind = 'BuYe' ); kind='(10,50,250)->(215,215,255)->white->(255,232,131)->(249,208,2)'; endif
  if( kind = 'spectral' ); kind='(94,79,162)->(50,136,189)->(102,194,165)->(171,221,164)->(230,245,152)->(255,255,191)->(254,224,139)->(253,174,97)->(244,109,67)->(213,62,79)->(158,1,66)'; endif
***** Parameter check *****
