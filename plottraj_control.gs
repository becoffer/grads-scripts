...
if(trajno<10)
   trajfil='selected/control_parcels.0000'trajno
endif
if(trajno>9)
  if(trajno<100)
     trajfil='selected/control_parcels.000'trajno
  endif
  if(trajno>99)
     trajfil='selected/control_parcels.00'trajno
  endif
  if(trajno>999)
     trajfil='selected/control_parcels.0'trajno
  endif
  if(trajno>9999)
     trajfil='selected/control_parcels.'trajno
  endif
endif
